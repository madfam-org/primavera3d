...
export const metadata: Metadata = {
  ...
  description:
    'Transform your ideas into reality with cutting-edge 3D modeling, parametric design, and digital fabrication services. Expert solutions in architecture, product design, and engineering.',
  keywords: [
    '3D modeling',
    'parametric design',
    'digital fabrication',
  ...
  openGraph: {
    ...
    description:
      'Transform your ideas into reality with cutting-edge 3D modeling and digital fabrication services.',
