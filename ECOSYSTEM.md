...
# Logs
enclii logs primavera3d-web --env prod -f                    # live tail
enclii logs primavera3d-web --env prod --since 1h -n 200     # last hour
...
# Rollback
enclii rollback primavera3d-web --env prod                   # previous release
enclii rollback primavera3d-web v42 --env prod

# Releases + deployment history
enclii releases primavera3d-web -n 20
...
enclii domains list --service primavera3d-web
enclii domains add my.example.com --service primavera3d-web   # auto-provisions tunnel route + DNS
